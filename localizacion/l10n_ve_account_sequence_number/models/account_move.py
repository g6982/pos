...
class AccountMove(models.Model):
    ...
    hide_book = fields.Boolean(string='Excluir de Libros', tracking=True)
    reason = fields.Char('Referencia de Factura')
    is_branch_office = fields.Boolean(string='Tiene sucursal', tracking=True)
    move_type = fields.Selection(selection_add=[('out_debit', 'Factura de Debito')], ondelete={"out_debit": "cascade"})
    _sql_constraints = [
