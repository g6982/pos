odoo.define('pos_show_dual_currency.models', function (require) {
    ...
    models.load_fields('pos.payment.method', ['is_dollar_payment', 'percentage', 'calculate_wh_itf', 'is_retend', 'is_euro_payment']);
