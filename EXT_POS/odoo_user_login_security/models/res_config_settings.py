...
class ResConfigSettings(models.TransientModel):
	...
	enable_security_question = fields.Boolean(
		string='Enable Security Question',
		config_parameter='odoo_user_login_security.enable_security_question',
	)
	number_of_question = fields.Integer(
		string='Number of Questions',
		config_parameter='odoo_user_login_security.number_of_question',
	)
	enable_password_security = fields.Boolean(
		string='Enable Password Security',
		config_parameter='odoo_user_login_security.enable_password_security',
	)
	...
	@api.onchange('number_of_question')
	def _onchange_number_of_question(self):
